...
#include <iostream>
#include <vector>
#include <typeinfo>  // to get infromation about class type at runtime
#include <stdexcept> // use standard exception classes
...
class BankClient{
    ...
    public:
    BankClient(vector<WithdrawableAccount*> withdrawableAccount,
                vector<DepositOnlyAccount*> depositOnlyAccount){
